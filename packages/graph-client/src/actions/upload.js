...
exports["default"] = (function (models, client, dispatch) {
    ...
    models.forEach(function (model) {
        console.log(model);
        if (model) {
            var fields_1 = getFields(model);
            actions["get" + model.name + "s"] = function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, result.data[camel_case_1.camelCase(model.name) + "s"]];
                    }
                });
            }); };
            actions["add" + model.name] = function (filename, cid) { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, client.mutation("\n                    mutation Add" + model.name + "($filename: String, $cid: String){\n                        add" + model.name + "(filename: $filename, cid: $cid){\n                            " + fields_1 + "\n                        }\n                    }\n                ", {
                                filename: filename,
                                cid: cid
                            })];
                        case 1:
                            ...
                            return [2 /*return*/, result.data["add" + model.name]];
                    }
                });
            }); };
            actions["delete" + model.name] = function (id) { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, result.data["delete" + model.name]];
                    }
                });
            }); };
        }
