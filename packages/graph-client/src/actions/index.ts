...
export class ActionFactory {
    ...
    constructor(client: WorkhubClient, models: ModelStorage, dispatch: any) {
        ...
        console.debug('Starting Action Manager with ', this.models.types)
    ...
    registerPlugins(){
        Object.keys(this.client.plugins).forEach((plugin_key) => {
            let plugin : HubPlugin = flow(this.client.plugins[plugin_key])
            this.actions = {
                ...this.actions,
                ...plugin(this.models.getByDirective(plugin_key), this.client, this.dispatch)
            }
        })
    }
