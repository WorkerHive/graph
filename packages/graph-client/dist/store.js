...
function clientReducer(state, action) {
    ...
    if (!store[actionParts[1]])
        store[actionParts[1]] = [];
    let ix = action.id != null ? store[actionParts[1]].map((x) => x.id).indexOf(action.id) : null;
    ...
    switch (actionParts[0]) {
        ...
        case 'UPDATE':
            ...
            if (ix > -1) {
                ...
                _part[ix] = Object.assign(Object.assign({}, _part[ix]), action.data);
