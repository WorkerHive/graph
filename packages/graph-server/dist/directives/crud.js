                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, (arr)];
                                case 1: return [2 /*return*/, (_a.sent()) ? (query != null) ? context.connector.readAll(name, query) : [] : (query != null) ? context.connector.read(name, query) : {}];
                            }
                        });
                    }); }
                },
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, context.connector.create(item.name, args[item.camelName])];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, context.connector.update(item.name, { id: args['id'] }, args[item.camelName])];
                            case 1: return [2 /*return*/, _a.sent()];
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, context.connector.delete(item.name, { id: id })];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, context.connector.read(item.name, { id: args['id'] })];
                            case 1: return [2 /*return*/, _a.sent()];
                ...
                resolve: function (parent, args, context) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!hasPermission(context.user, item.name, 'read')) return [3 /*break*/, 2];
                                return [4 /*yield*/, context.connector.readAll(item.name)];
                            case 1:
                                result = _a.sent();
