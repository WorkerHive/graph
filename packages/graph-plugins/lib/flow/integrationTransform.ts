...
import { FlowCRUD } from './flow-provider';
...
export const transform = (schema : SchemaComposer<any>, db: QueenDb) : {types: any, resolvers: any} => {
                   ...
                   name: 'String',
                    ...
                    pass: 'String'
                        */
                        ...
                        let userResult = await (context.connector as FlowCRUD).db.linkUser('postgres', integrationStore.name, {name: integrationStore.user, pass: integrationStore.pass})

                        let importResult = await (context.connector as FlowCRUD).db.importServer(integrationStore.name);
            ...
            schemaComposer.Query.addFields({
                ...
                stores: {
                    type: 'JSON',
                    resolve: async (parent, args, context : GraphContext) => {
                        return await (context.connector as FlowCRUD).db.getServers();
                ...
                storeLayout: {
                    ...
                    resolve: async (parent, args, context: GraphContext) => {
                        return await (context.connector as FlowCRUD).db.getServerTables(args.storeName)
                ...
                bucketLayout: {
                    ...
                    resolve: async (parent, args, context: GraphContext) => {
                        ...
                        const conn : FlowCRUD = (context.connector as FlowCRUD)
                ...
                integrationStore: {
                    ...
                    resolve: async (parent, args, context : GraphContext) => {
                        const stores : Array<any> = await (context.connector as FlowCRUD).db.getServers()
